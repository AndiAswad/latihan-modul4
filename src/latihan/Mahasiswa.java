...
public class Mahasiswa {
    String nama, kelas, matakuliah_praktikum;
    int nim;
    public Mahasiswa(String nm, String kl, String mat, int ni) {
        nama = nm;
        kelas = kl;
        matakuliah_praktikum = mat;
        nim = ni;
    }
    ...
    public static void main(String[] args){
        ...
        mhs.put("3", new Mahasiswa("Arra", "3O", "Pemrograman", 2020017));
        ...
        if(data != null){
            System.out.println("Data mahasiswa : "+ data.nama + ", kelas : "+
                    data.kelas + ", mata kuliah praktikum : " + data.matakuliah_praktikum +
                    ", nim : " + data.nim);
        } else {
